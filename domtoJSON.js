...
function importJSON( object = null ){
	...
	for (let i = output.children.length - 2; i >= 1; i--) {
	...
	for (var i = 0; i < object.parts.length ; i++) {
		...
		if ( typeof DOMpart == "string" ){
			...
			output.insertBefore(toAdd,lastZone);
